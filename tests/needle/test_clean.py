...
import needle.clean as clean_mod
...
class TestCleaningSequenceWithHMM(unittest.TestCase):
    ...
    def test_hmm_cleaned_protein_integration_with_mock_scoring(self):
        ...
        def _fake(cands, hmm): 
            ...
            return cands[0]
        try:
            clean_mod.score_and_select_best_transition = _fake
            ...
            clean_mod.score_and_select_best_transition = orig
    ...
    def test_hmm_clean_protein_adjusts_overlap_coordinates(self):
        ...
        def _fake(cands, hmm):
            ...
            return cands[0]
        try:
            clean_mod.score_and_select_best_transition = _fake  # type: ignore
            cleaned_pm = hmm_clean_protein(pm, "dummy.hmm", overlap_flanking_len=5)
        finally:
            clean_mod.score_and_select_best_transition = orig  # type: ignore
